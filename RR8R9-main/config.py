...
BOT_TOKEN = getenv("BOT_TOKEN", "7804465653:AAHq9pF0UT8UM1YXhQYNuRZJkpH-lYej1uQ")

MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ConcreteM_Bot")

Muntazer = getenv("concrat", "")
...
LOGGER_ID = int(getenv("LOGGER_ID", "7804465653"))

OWNER_ID = int(getenv("OWNER_ID", "1854384004"))

BOT_USERNAME = getenv("BOT_USERNAME" , "ConcreteM_Bot")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/C_onc")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/I_EE_4")
